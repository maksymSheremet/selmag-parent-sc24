...
import my.code.catalogue.controller.payload.UpdateProductPayload;
...
class ProductRestControllerTest {
    ...
    void handleNoSuchElementException_ReturnsNotFound() {
        ...
        var locale = Locale.of("en", "En");

        doReturn("error details").when(this.messageSource)
                .getMessage("error_code", new Object[0], "error_code", Locale.of("en", "En"));
    ...
    private static @NotNull Product getProduct() {
        return new Product(1, "Product name", "Product Description");
    }
